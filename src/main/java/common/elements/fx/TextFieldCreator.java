...
public class TextFieldCreator extends FxTextElementAttributes {
    ...
    public static TextField getAuthorTextField() {
        final TextField author = new TextField(DEFAULT_TEXT + AUTHOR.getParam());
    ...
    public static TextField getTrackTextField() {
        final TextField track = new TextField(DEFAULT_TEXT + TRACK.getParam());
    ...
    public static TextField getGenreTextField() {
        final TextField genre = new TextField(DEFAULT_TEXT + GENRE.getParam());
